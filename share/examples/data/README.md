...
- `sample_data.json`: A sample dataset containing example records

## Usage

These data files can be used with the example scripts in the `examples/basic` directory to demonstrate loading data, querying, and performing operations on the database.
