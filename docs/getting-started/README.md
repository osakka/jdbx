...
- **Native JSON Storage** - Store and query JSON documents without schema restrictions
- **High Performance** - Sub-millisecond queries with memory-mapped storage
- **JavaScript Integration** - Built-in scripting for validation and transformation
...
- 10 minutes for the quick start tutorial
...
4. Try the [JavaScript Integration](../guides/javascript-integration.md)

### 3. Ready for Production
1. Read the [Production Deployment Guide](../guides/production-deployment.md)
2. Configure [Authentication](../guides/authentication.md)
3. Set up [Monitoring](../guides/monitoring.md)
4. Plan for [Backup and Recovery](../guides/backup-recovery.md)
