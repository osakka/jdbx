...
/* Document flags */
#define DOC_FLAG_DELETED    0x00000001  /* Document is deleted */
#define DOC_FLAG_COMPRESSED 0x00000002  /* Document is compressed */
#define DOC_FLAG_ENCRYPTED  0x00000004  /* Document is encrypted */

/* Document entry in storage */
typedef struct CACHE_ALIGNED doc_entry {
    uint32_t magic;         /* 0xDOCU */
    uint32_t flags;         /* Compression, encryption, deleted, etc */
